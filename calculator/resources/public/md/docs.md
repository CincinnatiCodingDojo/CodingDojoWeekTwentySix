...
Two middleware functions are provided by default in the `calculator.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `calculator.handler` namespace to manage the enabled middleware.
